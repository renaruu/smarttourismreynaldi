...
df_wisata["cluster"] = df_km["cluster_fuzzy"].values
...
print("=" * 50)
print("  STATISTIK KLASTER FUZZY C-MEANS")
print("=" * 50)
...
fig.suptitle("Distribusi Klaster Fuzzy C-Means (k=5)",
...
plt.tight_layout()
plt.savefig("barchart_fuzzycmeans.png", dpi=150, bbox_inches="tight")
print("\n  ✅  Grafik tersimpan : barchart_fuzzycmeans.png")
plt.show()