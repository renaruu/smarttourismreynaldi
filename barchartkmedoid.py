...
df_wisata["cluster"] = df_km["cluster_kmedoid"].values
...
print("=" * 50)
print("  STATISTIK KLASTER KMEDOID")
print("=" * 50)
...
fig.suptitle("Distribusi Klaster K-Medoids (k=5)",
...
plt.tight_layout()
plt.savefig("barchart_kmedoid.png", dpi=150, bbox_inches="tight")
print("\n  ✅  Grafik tersimpan : barchart_kmedoid.png")
plt.show()